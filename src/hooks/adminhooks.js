...
import { useToast, Menu, MenuList, MenuItem, MenuButton, Button, Flex, Input, Image, InputGroup, InputLeftAddon, Box, InputRightElement, Text, PopoverTrigger, PopoverContent, PopoverBody, Popover, PopoverHeader, Badge } from "@chakra-ui/react"
                                    ...
                                    <Box w="90%" >
                                        {
                                            res.isDraft == "true" ?
                                                <Box fontSize="1.2em" mb="3px" w={'fit-content'}>
                                                    {res.title}
                                                    <Badge ml="10px" colorScheme="green" >Draft</Badge>
                                                </Box>
                                                :
                                                <Box fontSize="1.2em" mb="3px" w={'fit-content'}>
